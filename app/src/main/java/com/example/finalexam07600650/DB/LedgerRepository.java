...
public class LedgerRepository {
    ...
    public void getLedger(String username,String password,Callback callback){
        GetTask getTask = new GetTask(mContext,username,password,callback);
        getTask.execute();
    }
    ...
    private  static class GetTask extends AsyncTask<Void,Void, List<LedgerItem>>{
        ...
        public GetTask(Context context,String mUsername,String mPassword,Callback callback){
